...
union YYSTYPE
{
#line 20 "zoomjoystrong.y" /* yacc.c:355  */
...
{
  "$end", "error", "$undefined", "SEPARATOR", "END", "END_STATEMENT",
  "POINT", "LINE", "CIRCLE", "RECTANGLE", "SET_COLOR", "INT", "FLOAT",
  "$accept", "statement_list", "statement", "draw_point", "draw_line",
  "draw_circle", "draw_rectangle", "set_color", "quit", YY_NULLPTR
};
#endif
...
{
      -4,     2,   -10,    -3,    -2,    -1,     0,    12,    -4,   -11,
     -11,   -11,   -11,   -11,   -11,   -11,     3,     4,     5,     6,
       7,   -11,   -11,     8,     9,    10,    11,    13,   -11,    14,
      18,    15,    22,    23,   -11,    24,   -11,   -11,   -11
};
...
static const yytype_uint8 yytable[] =
{
      ...
      29,    30,    31,    34,    32,    33,    35,    36,    37,    38,
       0,     0,     0,    22
};

static const yytype_int8 yycheck[] =
{
       4,    11,     6,     7,     8,     9,    10,     5,    11,    11,
      11,    11,     0,     5,    11,    11,    11,    11,    11,    -1,
      11,    11,    11,     5,    11,    11,    11,     5,     5,     5,
      -1,    -1,    -1,     8
};
...
static const yytype_uint8 yystos[] =
{
      ...
      17,    18,    19,    20,    21,     5,    11,    11,    11,    11,
      11,     0,    14,    11,    11,    11,    11,    11,     5,    11,
...
#line 50 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("draw_point: x: %d y: %d\n", (yyvsp[-2].intVal), (yyvsp[-1].intVal)); 
			if ((yyvsp[-2].intVal) < 0 || (yyvsp[-2].intVal) > W)
				yyerror("X coordinate not between 0-1024.");
			if ((yyvsp[-1].intVal) < 0 || (yyvsp[-1].intVal) > H)
...
#line 61 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("drawline: x: %d y: %d u: %d v: %d\n", (yyvsp[-4].intVal), (yyvsp[-3].intVal), (yyvsp[-2].intVal), (yyvsp[-1].intVal)); 
			if ((yyvsp[-4].intVal) < 0 || (yyvsp[-4].intVal) > W)
				yyerror("X coordinate not between 0-1024.");
			if ((yyvsp[-3].intVal) < 0 || (yyvsp[-3].intVal) > H)
				yyerror("Y coordinate not between 0-768.");
			if ((yyvsp[-2].intVal) < 0 || (yyvsp[-2].intVal) > W)
...
#line 77 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("draw_circle: x: %d y: %d r: %d\n", (yyvsp[-3].intVal), (yyvsp[-2].intVal), (yyvsp[-1].intVal)); 
			if ((yyvsp[-3].intVal) < 0 || (yyvsp[-3].intVal) > W)
				yyerror("X coordinate not between 0-1024.");
			if ((yyvsp[-2].intVal) < 0 || (yyvsp[-2].intVal) > H)
				yyerror("Y coordinate not between 0-768.");
			if ((yyvsp[-1].intVal) < 0 || (yyvsp[-1].intVal) > H)
...
#line 106 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("set_color to: r: %d g: %d b: %d\n", (yyvsp[-3].intVal), (yyvsp[-2].intVal), (yyvsp[-1].intVal)); 
			if ((yyvsp[-3].intVal) < 0 || (yyvsp[-3].intVal) > 255)
				yyerror("Red value not between 0-255.");
			if ((yyvsp[-2].intVal) < 0 || (yyvsp[-2].intVal) > 255)
				yyerror("Green value not between 0-255.");
			if ((yyvsp[-1].intVal) < 0 || (yyvsp[-1].intVal) > 255)
				yyerror("Blue value not between 0-255.");
			else
				set_color((yyvsp[-3].intVal), (yyvsp[-2].intVal), (yyvsp[-1].intVal));
		}
#line 1313 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 119 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("Goodbye.\n");
   		 	finish();
			exit(0);
		}
...
#line 125 "zoomjoystrong.y" /* yacc.c:1906  */
